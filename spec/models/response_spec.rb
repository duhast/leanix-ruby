...
# Unit tests for LeanixApi::Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LeanixApi::Response do
  let(:instance) { LeanixApi::Response.new }

  describe 'test an instance of Response' do
    it 'should create an instance of Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LeanixApi::Response)
    end
  end
