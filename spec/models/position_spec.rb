...
# Unit tests for LeanixApi::Position
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LeanixApi::Position do
  let(:instance) { LeanixApi::Position.new }

  describe 'test an instance of Position' do
    it 'should create an instance of Position' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LeanixApi::Position)
    end
  end
