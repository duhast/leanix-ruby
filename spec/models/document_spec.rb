...
# Unit tests for LeanixApi::Document
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LeanixApi::Document do
  let(:instance) { LeanixApi::Document.new }

  describe 'test an instance of Document' do
    it 'should create an instance of Document' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LeanixApi::Document)
    end
  end
  ...
  describe 'test attribute "file_information"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
