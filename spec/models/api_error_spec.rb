...
# Unit tests for LeanixApi::ApiError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LeanixApi::ApiError do
  let(:instance) { LeanixApi::ApiError.new }

  describe 'test an instance of ApiError' do
    it 'should create an instance of ApiError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LeanixApi::ApiError)
    end
  end
