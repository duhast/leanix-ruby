...
module LeanixApi
  class FactSheetConfiguration
    ...
    attr_accessor :impact_management

    attr_accessor :milestones_active
    ...
    def self.attribute_map
      {
        ...
        :'impact_management' => :'impactManagement',
        :'milestones_active' => :'milestonesActive'
      }
    end
    ...
    def self.openapi_types
      {
        :'quality_seal' => :'ConfigTypeOnOffWithTime',
        :'approval_workflow' => :'ApprovalWorkflowConfiguration',
        :'max_hierarchy_level' => :'Integer',
        :'default_acl' => :'String',
        :'impact_management' => :'ImpactManagementDefinition',
        :'milestones_active' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LeanixApi::FactSheetConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LeanixApi::FactSheetConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'impact_management')
        self.impact_management = attributes[:'impact_management']
      end

      if attributes.key?(:'milestones_active')
        self.milestones_active = attributes[:'milestones_active']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          impact_management == o.impact_management &&
          milestones_active == o.milestones_active
    end
    ...
    def hash
      [quality_seal, approval_workflow, max_hierarchy_level, default_acl, impact_management, milestones_active].hash
    end
